...
async function createFlyer(squares: Square[],language:"es"|"en"="es",season:SeasonConfig=defaultSeason) {
  ...
  season.games.forEach((game,index)=>{const y=1540+index*59;if(index%2===0){ctx.fillStyle="#ffffff0c";ctx.fillRect(88,y,904,54);}ctx.textBaseline="middle";ctx.textAlign="center";ctx.fillStyle=gold;ctx.font=`400 18px ${displayFont}`;ctx.fillText(String(index+1).padStart(2,"0"),115,y+27);ctx.fillStyle="#b8c7dc";ctx.font=`800 14px ${bodyFont}`;ctx.fillText(game.date.toUpperCase(),190,y+27);const visitorLogo=teamLogos.get(game.visitor),homeLogo=teamLogos.get(game.home);if(visitorLogo)ctx.drawImage(visitorLogo,265,y+5,44,44);if(homeLogo)ctx.drawImage(homeLogo,720,y+5,44,44);ctx.fillStyle=white;ctx.font=`700 17px ${bodyFont}`;ctx.textAlign="left";ctx.fillText(fitCanvasText(ctx,game.visitor,290),318,y+27);ctx.textAlign="center";ctx.fillStyle=gold;ctx.font=`400 17px ${displayFont}`;ctx.fillText("@",690,y+27);ctx.fillStyle=white;ctx.font=`700 17px ${bodyFont}`;ctx.textAlign="left";ctx.fillText(fitCanvasText(ctx,game.home,210),775,y+27);});ctx.textBaseline="alphabetic";

  ctx.textAlign="left"; ctx.fillStyle=gold;canvasFontToFit(ctx,copy.rulesTitle,916,30,displayFont,22);ctx.fillText(copy.rulesTitle,82,2612);
  const rules=copy.rules.map((text,index)=>[String(index+1),text]);
  rules.forEach(([number,text],index)=>{const y=2652+index*42;ctx.font=`600 16px ${bodyFont}`;const lineCount=countWrappedTextLines(ctx,text,535),circleY=y-7+((lineCount-1)*18)/2;ctx.fillStyle=gold;ctx.beginPath();ctx.arc(100,circleY,16,0,Math.PI*2);ctx.fill();ctx.fillStyle=navy;ctx.textAlign="center";ctx.font=`400 17px ${displayFont}`;ctx.fillText(number,100,circleY+6);ctx.fillStyle=white;ctx.textAlign="left";ctx.font=`600 16px ${bodyFont}`;drawWrappedText(ctx,text,130,y,535,18);});const motto=english?mottoEn:mottoEs,mottoW=250,mottoH=mottoW*(motto.height/motto.width),mottoY=2641+(150-mottoH)/2;ctx.fillStyle=gold;ctx.fillRect(700,2635,3,158);roundedBox(ctx,725,2635,285,158,18,"#051631a8",null,0);ctx.drawImage(motto,742,mottoY,mottoW,mottoH);
  roundedBox(ctx,70,2810,940,126,20,"#071a3be8",gold,2);ctx.textAlign="center";ctx.fillStyle=gold;ctx.font=`400 18px ${displayFont}`;ctx.fillText(copy.exampleTitle,540,2838);ctx.fillStyle="#aebed3";ctx.font=`800 12px ${bodyFont}`;ctx.fillText(english?"VISITOR":"VISITANTE",220,2872);ctx.fillText(english?"HOME":"CASA",860,2872);ctx.fillStyle=white;ctx.font=`400 38px ${displayFont}`;ctx.fillText("17",220,2907);ctx.fillText("10",860,2907);roundedBox(ctx,420,2856,240,55,12,gold,null,0);ctx.fillStyle=navy;ctx.font=`400 30px ${displayFont}`;ctx.fillText("7 × 0",540,2894);ctx.fillStyle=white;ctx.font=`600 15px ${bodyFont}`;ctx.fillText(copy.exampleCopy,540,2926);
  ctx.fillStyle="#b8c7dc";ctx.textAlign="center";ctx.font=`800 15px ${bodyFont}`;ctx.fillText(copy.warning,540,2980);
  roundedBox(ctx,70,3020,940,126,20,"#071a3be8",gold,3);ctx.fillStyle=white;ctx.font=`400 27px ${displayFont}`;ctx.fillText(copy.cta,540,3062);ctx.fillStyle=gold;ctx.font=`700 18px ${bodyFont}`;ctx.fillText(english?"GET YOUR SQUARE TODAY":"APARTA TU CASILLA HOY",540,3105);
