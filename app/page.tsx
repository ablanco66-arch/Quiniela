...
async function createFlyer(squares: Square[],language:"es"|"en"="es",season:SeasonConfig=defaultSeason) {
  ...
  roundedBox(ctx,122,596,836,842,26,"#03112be8",gold,4);
  ctx.fillStyle=gold;ctx.textAlign="center";ctx.font=`400 19px ${displayFont}`;ctx.fillText(english?"VISITOR":"VISITANTE",542.5,621);ctx.save();ctx.translate(136,1022.5);ctx.rotate(-Math.PI/2);ctx.textBaseline="middle";ctx.fillText(english?"HOME":"CASA",0,0);ctx.restore();
