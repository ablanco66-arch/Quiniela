...
async function createPaymentFlyer(language:"es"|"en"="es"){
  ...
  roundedBox(ctx,718,688,294,380,24,"#071a3bef",gold,3);ctx.fillStyle=gold;ctx.font=`400 25px ${displayFont}`;ctx.fillText(copy.codi,865,735);ctx.fillStyle=white;ctx.font=`400 34px ${displayFont}`;ctx.fillText("$1,800 MXN",865,780);ctx.fillStyle=white;roundedBox(ctx,765,803,200,200,10,white,null,0);ctx.save();ctx.imageSmoothingEnabled=false;ctx.drawImage(codiQr,775,813,180,180);ctx.restore();ctx.fillStyle=gold;ctx.font=`800 15px ${bodyFont}`;ctx.fillText(copy.scan1,865,1030);ctx.fillText(copy.scan2,865,1052);
