...
async function createWinnerFlyer({result,game,square,visitorDigit,homeDigit}:WinnerRow){
  ...
  ctx.textAlign="center";ctx.fillStyle=gold;ctx.font=`400 28px ${sportFont}`;ctx.fillText("QUINIELA MNF 2026",540,276);ctx.fillStyle=white;ctx.font=`400 78px ${sportFont}`;ctx.strokeStyle=navy;ctx.lineWidth=9;ctx.strokeText("¡TENEMOS GANADOR!",540,363);ctx.fillText("¡TENEMOS GANADOR!",540,363);ctx.fillStyle=cream;ctx.font=`400 25px ${sportFont}`;ctx.fillText("TU PARTICIPACIÓN HACE POSIBLE GRANDES CAUSAS",540,410);
  ...
  roundedBox(ctx,86,528,908,270,26,"#051631d9",gold,4);ctx.fillStyle=gold;ctx.font=`400 27px ${sportFont}`;ctx.fillText("FELICIDADES",540,606);ctx.fillStyle=white;ctx.font=`400 74px ${sportFont}`;ctx.strokeStyle=navy;ctx.lineWidth=11;const winnerName=fitCanvasText(ctx,(square.participant||"CASILLA GANADORA").toUpperCase(),800);ctx.strokeText(winnerName,540,704);ctx.fillText(winnerName,540,704);ctx.fillStyle=gold;ctx.fillRect(250,752,580,5);
  ...
  const scoreTeams=[[game.visitor,result.visitorScore,"VISITANTE",290],[game.home,result.homeScore,"CASA",790]] as const;scoreTeams.forEach(([team,score,side,x])=>{ctx.fillStyle=gold;ctx.font=`400 18px ${sportFont}`;ctx.fillText(side,x,1181);ctx.fillStyle=white;ctx.font=`400 27px ${sportFont}`;ctx.fillText(fitCanvasText(ctx,team.toUpperCase(),350),x,1225);ctx.fillStyle=gold;ctx.font=`400 70px ${sportFont}`;ctx.fillText(String(score),x,1300);});ctx.fillStyle="#8fa0b8";ctx.font=`400 26px ${sportFont}`;ctx.fillText("VS",540,1252);
  ...
  ctx.fillStyle="#aebed3";ctx.font=`800 18px ${bodyFont}`;ctx.fillText("CASILLA COLOCADA POR",540,1516);ctx.fillStyle=white;ctx.font=`400 35px ${sportFont}`;ctx.fillText(fitCanvasText(ctx,(square.reservedByName||square.contact||"ROTARY JUÁREZ CONCORDIA").toUpperCase(),800),540,1562);
  ctx.fillStyle=gold;ctx.font=`400 31px ${sportFont}`;ctx.fillText("¡GRACIAS POR JUGAR, GANAR Y AYUDAR!",540,1642);ctx.fillStyle="#d5deeb";ctx.font=`600 22px ${bodyFont}`;ctx.fillText("Cada casilla fortalece proyectos que transforman vidas.",540,1682);
