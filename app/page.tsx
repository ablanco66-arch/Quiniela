...
async function createReportFlyer(rows:ReportRow[]){
  ...
  roundedBox(ctx,60,tableY-18,960,tableH+36,24,"#03112bec",gold,3);ctx.fillStyle="#0d2e61";ctx.fillRect(82,tableY,916,58);ctx.textBaseline="middle";ctx.fillStyle=gold;ctx.font=`400 20px ${displayFont}`;ctx.textAlign="center";ctx.fillText("#",110,tableY+29);ctx.textAlign="left";ctx.fillText("SOCIO",145,tableY+29);[["RESERVADAS",690],["PAGADAS",835],["TOTAL",960]].forEach(([label,x])=>{ctx.textAlign="center";ctx.fillText(String(label),Number(x),tableY+29);});
