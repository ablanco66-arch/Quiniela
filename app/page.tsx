...
async function createFlyer(squares: Square[],language:"es"|"en"="es",season:SeasonConfig=defaultSeason) {
  ...
  ctx.fillStyle=gold;ctx.textAlign="center";ctx.font=`400 17px ${displayFont}`;ctx.fillText(english?"VISITOR":"VISITANTE",540,620);ctx.save();ctx.translate(137,1020);ctx.rotate(-Math.PI/2);ctx.fillText(english?"HOME":"CASA",0,0);ctx.restore();
